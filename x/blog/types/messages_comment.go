...
func NewMsgUpdateComment(creator string, id string, body string, postID string) *MsgUpdateComment {
...
func NewMsgDeleteComment(creator string, id string) *MsgDeleteComment {
