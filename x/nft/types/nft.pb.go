...
type TokenisedNFT struct {
	BaseNFT    *BaseNFT   `protobuf:"bytes,1,opt,name=baseNFT,proto3" json:"baseNFT,omitempty"`
	HashRateId string     `protobuf:"bytes,2,opt,name=hash_rate_id,json=hashRateId,proto3" json:"hash_rate_id,omitempty"`
	ExpiresOn  *time.Time `protobuf:"bytes,3,opt,name=expiresOn,proto3,stdtime" json:"expiresOn,omitempty"`
}

func (m *TokenisedNFT) Reset()         { *m = TokenisedNFT{} }
func (m *TokenisedNFT) String() string { return proto.CompactTextString(m) }
func (*TokenisedNFT) ProtoMessage()    {}
func (*TokenisedNFT) Descriptor() ([]byte, []int) {
	return fileDescriptor_fe8ab7e15b7f0646, []int{1}
}
func (m *TokenisedNFT) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TokenisedNFT) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TokenisedNFT.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TokenisedNFT) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenisedNFT.Merge(m, src)
}
func (m *TokenisedNFT) XXX_Size() int {
	return m.Size()
}
func (m *TokenisedNFT) XXX_DiscardUnknown() {
	xxx_messageInfo_TokenisedNFT.DiscardUnknown(m)
}

var xxx_messageInfo_TokenisedNFT proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*TokenisedNFT)(nil), "cudosnode.cudosnode.nft.TokenisedNFT")
...
var fileDescriptor_fe8ab7e15b7f0646 = []byte{
	...
	,
}
...
func (this *TokenisedNFT) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TokenisedNFT)
	if !ok {
		that2, ok := that.(TokenisedNFT)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.BaseNFT.Equal(that1.BaseNFT) {
		return false
	}
	if this.HashRateId != that1.HashRateId {
		return false
	}
...
func (m *TokenisedNFT) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TokenisedNFT) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TokenisedNFT) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.HashRateId) > 0 {
		i -= len(m.HashRateId)
		copy(dAtA[i:], m.HashRateId)
		i = encodeVarintNft(dAtA, i, uint64(len(m.HashRateId)))
		i--
		dAtA[i] = 0x12
	}
	if m.BaseNFT != nil {
...
func (m *TokenisedNFT) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TokenisedNFT) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TokenisedNFT: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TokenisedNFT: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HashRateId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HashRateId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
