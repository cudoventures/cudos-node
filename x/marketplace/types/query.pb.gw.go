...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"CudoVentures", "cudos-node", "marketplace", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Collection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"CudoVentures", "cudos-node", "marketplace", "collection", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CollectionAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"CudoVentures", "cudos-node", "marketplace", "collection"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Nft_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"CudoVentures", "cudos-node", "marketplace", "nft", "id"}, "", runtime.AssumeColonVerbOpt(false)))
