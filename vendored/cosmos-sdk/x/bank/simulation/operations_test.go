...
func (suite *SimTestSuite) TestSimulateMsgSend() {
	...
	suite.Require().Equal("107242728498552699278stake", msg.Amount.String())
...
func (suite *SimTestSuite) TestSimulateMsgMultiSend() {
	...
	require.Equal("111202564177997141612stake", msg.Inputs[1].Coins.String())
	require.Len(msg.Outputs, 2)
	require.Equal("cosmos1tnh2q55v8wyygtt9srz5safamzdengsnqeycj3", msg.Outputs[1].Address)
	require.Equal("73621086044059212126stake", msg.Outputs[1].Coins.String())
